%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% warp_5ghz_sniffer_v7
%
% The RXers listen to RF_A/B/C/D in channels RX_CHANNEL_A/B/C/D.
% Note that signals are cut just to a hardcoded number of buffer samples, i.e., N_OFDM_SYMS
% may be not relevant at all.
%
